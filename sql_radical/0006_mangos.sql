-- Matanza de Stratholme, SQL del merge del R2 (thx FallenAngel)
...
DELETE FROM `creature` WHERE `id`=27745;
...
DELETE FROM `creature` WHERE `id`=27747;
INSERT INTO `creature` (`guid`,`id`,`map`,`spawnMask`,`phaseMask`,`modelid`,`equipment_id`,`position_x`,`position_y`,`position_z`,`orientation`,`spawntimesecs`,`spawndist`,`currentwaypoint`,`curhealth`,`curmana`,`DeathState`,`MovementType`) VALUES
...
UPDATE `locales_npc_text` SET `Text0_0_loc6` = '¿Estáis listos para enfrentaros a Mal\'Ganis conmigo?' WHERE `entry` = 13287;

UPDATE `locales_npc_text` SET `Text0_0_loc7` = `Text0_0_loc6`;